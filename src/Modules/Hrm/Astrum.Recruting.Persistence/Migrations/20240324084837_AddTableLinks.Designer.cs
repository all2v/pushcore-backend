...
namespace Astrum.Recruting.Persistence.Migrations
{
    ...
    [Migration("20240324084837_AddTableLinks")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Astrum.Recruting.Domain.Aggregates.Board.KanbanBoard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("KanbanBoards", "Recruting");
                });
            ...
            modelBuilder.Entity("Astrum.Recruting.Domain.Aggregates.Board.StageCard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("StageCards", "Recruting");
                });
            ...
            modelBuilder.Entity("Astrum.Recruting.Domain.Aggregates.Board.Stage", b =>
                {
                    b.HasOne("Astrum.Recruting.Domain.Aggregates.Board.KanbanBoard", "KanbanBoard")
                        .WithMany("Stages")
            ...
            modelBuilder.Entity("Astrum.Recruting.Domain.Aggregates.Board.StageEvent", b =>
                {
                    ...
                    b.HasOne("Astrum.Recruting.Domain.Aggregates.Board.StageCard", "StageCard")
                        .WithMany("CardEvents")
                        .HasForeignKey("StageCardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("StageCard");
                });
            ...
            modelBuilder.Entity("Astrum.Recruting.Domain.Aggregates.Vacancy.VacancyCandidate", b =>
                {
                    b.HasOne("Astrum.Recruting.Domain.Aggregates.Vacancy.Vacancy", "Vacancy")
                        .WithMany()
            ...
            modelBuilder.Entity("Astrum.Recruting.Domain.Aggregates.Board.Stage", b =>
                {
                    b.Navigation("StageCards");
                });

            modelBuilder.Entity("Astrum.Recruting.Domain.Aggregates.Board.StageCard", b =>
                {
                    b.Navigation("CardEvents");
                });
